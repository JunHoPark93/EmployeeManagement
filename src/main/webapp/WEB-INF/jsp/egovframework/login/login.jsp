...
<nav class="navbar navbar-transparent navbar-absolute">
    <div class="container">    
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="">Beauty Master Employee Management</a>
        </div>
...
<div class="wrapper wrapper-full-page">
    <div class="full-page login-page" data-color="orange" data-image="/home.do">   
...
<!--  Bootstrap Dashboard Core javascript and methods
